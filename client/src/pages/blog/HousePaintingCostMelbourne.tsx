        ...
        <div className="container max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-700 mb-4">
              Our <Link href="/services/interior-painting" className="text-[#007A99] hover:underline">interior painting services</Link> include 
            ...
            <p className="text-gray-700 mb-4">
              Our <Link href="/services/exterior-painting" className="text-[#007A99] hover:underline">exterior painting services</Link> use 
              weather-resistant coatings designed for Melbourne's harsh UV and variable climate. We also offer 
              <Link href="/services/roof-painting" className="text-[#007A99] hover:underline"> roof painting</Link> from $3,500.
            </p>
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
              ...
              <li><strong>Location</strong> — Premium suburbs like <Link href="/painter-toorak" className="text-[#007A99] hover:underline">Toorak</Link> and <Link href="/painter-brighton" className="text-[#007A99] hover:underline">Brighton</Link> often have larger homes</li>
            </ul>
            ...
            <p className="text-gray-700 mb-6">
              ...
              <Link href="/painter-malvern" className="text-[#007A99] hover:underline"> Malvern</Link>, 
              <Link href="/painter-camberwell" className="text-[#007A99] hover:underline"> Camberwell</Link>, 
              <Link href="/painter-hawthorn" className="text-[#007A99] hover:underline"> Hawthorn</Link>, and 
              <Link href="/keysborough-painters" className="text-[#007A99] hover:underline"> Keysborough</Link>.
            </p>
