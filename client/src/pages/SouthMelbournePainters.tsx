...
export default function SouthMelbournePainters() {
  return (
    <SuburbPageTemplate
      suburb={suburb}
      title="South Melbourne Painters | Heritage & Period Homes"
      description="Heritage and period home painters in South Melbourne — double-fronted terraces with ornate render facades. Free quotes, 5-year guarantee. Call 0432 077 782."
