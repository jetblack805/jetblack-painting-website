        ...
        <div className="container max-w-4xl">
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/services/interior-painting" className="bg-[#1A1713] px-4 py-2 rounded-lg border border-[#2A261F] text-[#EDE6D8] hover:border-[#E3C878] hover:text-[#E3C878] transition-all font-medium">Interior Painting</Link>
              <Link href="/services/exterior-painting" className="bg-[#1A1713] px-4 py-2 rounded-lg border border-[#2A261F] text-[#EDE6D8] hover:border-[#E3C878] hover:text-[#E3C878] transition-all font-medium">Exterior Painting</Link>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/services/body-corporate-painting" className="text-[#C9A227] hover:underline font-medium">Body Corporate Painting</Link>
