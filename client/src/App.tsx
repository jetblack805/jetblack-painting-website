...
const BathroomTileResurfacing = lazy(() => import("./pages/BathroomTileResurfacing"));
...
const ChoosingAPainterMelbourne = lazy(() => import("./pages/blog/ChoosingAPainterMelbourne"));
const WeatherboardPaintingGuide = lazy(() => import("./pages/blog/WeatherboardPaintingGuide"));
// <generated-blog-imports>
const SprayVsBrushPaintingMelbourne = lazy(() => import("./pages/blog/SprayVsBrushPaintingMelbourne"));
...
const WhatToPaintBeforeYouSell = lazy(() => import("./pages/blog/WhatToPaintBeforeYouSell"));
// </generated-blog-imports>
...
const DromanaPainters = lazy(() => import("./pages/DromanaPainters"));
...
const CranbournePainters = lazy(() => import("./pages/CranbournePainters"));
...
const NarreWarrenPainters = lazy(() => import("./pages/NarreWarrenPainters"));
const OrmondPainters = lazy(() => import("./pages/OrmondPainters"));
const RingwoodPainters = lazy(() => import("./pages/RingwoodPainters"));
const RosebudPainters = lazy(() => import("./pages/RosebudPainters"));
...
const SorrentoPainters = lazy(() => import("./pages/SorrentoPainters"));
const SomervillePainters = lazy(() => import("./pages/SomervillePainters"));
const ClydePainters = lazy(() => import("./pages/ClydePainters"));
const HastingsPainters = lazy(() => import("./pages/HastingsPainters"));
...
const AspendaleGardensPainters = lazy(() => import("./pages/AspendaleGardensPainters"));
const ChelseaPainters = lazy(() => import("./pages/ChelseaPainters"));
const ChelseaHeightsPainters = lazy(() => import("./pages/ChelseaHeightsPainters"));
...
const FrankstonSouthPainters = lazy(() => import("./pages/FrankstonSouthPainters"));
...
const StKildaPainters = lazy(() => import("./pages/StKildaPainters"));
const PortMelbournePainters = lazy(() => import("./pages/PortMelbournePainters"));
const AlbertParkPainters = lazy(() => import("./pages/AlbertParkPainters"));
const FitzroyPainters = lazy(() => import("./pages/FitzroyPainters"));
const CollingwoodPainters = lazy(() => import("./pages/CollingwoodPainters"));
const ClydeNorthPainters = lazy(() => import("./pages/ClydeNorthPainters"));
...
const SouthMelbournePainters = lazy(() => import("./pages/SouthMelbournePainters"));
const LyndhurstPainters = lazy(() => import("./pages/LyndhurstPainters"));
const RowvillePainters = lazy(() => import("./pages/RowvillePainters"));
const WantirnaSouthPainters = lazy(() => import("./pages/WantirnaSouthPainters"));
const CanterburyPainters = lazy(() => import("./pages/CanterburyPainters"));
...
function Router() {
  return (
    ...
    <Switch>
      ...
      <Route path={"/services/epoxy-flooring"} component={EpoxyFlooring} />
      <Route path={"/services/bathroom-tile-resurfacing"} component={BathroomTileResurfacing} />
      <Route path={"/services/property-maintenance"} component={PropertyMaintenance} />
      ...
      <Route path={"/painter-hampton-east"} component={HamptonEastPainters} />
      <Route path={"/painters-hampton-east"} component={HamptonEastPainters} />
      ...
      <Route path={"/painter-dromana"} component={DromanaPainters} />
      <Route path={"/painters-dromana"} component={DromanaPainters} />
      ...
      <Route path={"/painter-cranbourne"} component={CranbournePainters} />
      <Route path={"/painters-cranbourne"} component={CranbournePainters} />
      ...
      <Route path={"/painter-narre-warren"} component={NarreWarrenPainters} />
      <Route path={"/painters-narre-warren"} component={NarreWarrenPainters} />
      ...
      <Route path={"/painter-rosebud"} component={RosebudPainters} />
      <Route path={"/painters-rosebud"} component={RosebudPainters} />
      ...
      <Route path={"/painter-sorrento"} component={SorrentoPainters} />
      <Route path={"/painters-sorrento"} component={SorrentoPainters} />
      <Route path={"/painter-somerville"} component={SomervillePainters} />
      <Route path={"/painters-somerville"} component={SomervillePainters} />
      <Route path={"/painter-clyde"} component={ClydePainters} />
      <Route path={"/painters-clyde"} component={ClydePainters} />
      <Route path={"/painter-hastings"} component={HastingsPainters} />
      <Route path={"/painters-hastings"} component={HastingsPainters} />
      ...
      <Route path={"/painter-patterson-lakes"} component={PattersonLakesPainters} />
      <Route path={"/painters-patterson-lakes"} component={PattersonLakesPainters} />
      <Route path={"/painter-aspendale"} component={AspendalePainters} />
      <Route path={"/painters-aspendale"} component={AspendalePainters} />
      <Route path={"/painter-aspendale-gardens"} component={AspendaleGardensPainters} />
      <Route path={"/painters-aspendale-gardens"} component={AspendaleGardensPainters} />
      <Route path={"/painter-chelsea"} component={ChelseaPainters} />
      <Route path={"/painters-chelsea"} component={ChelseaPainters} />
      <Route path={"/painter-chelsea-heights"} component={ChelseaHeightsPainters} />
      <Route path={"/painters-chelsea-heights"} component={ChelseaHeightsPainters} />
      ...
      <Route path={"/painter-frankston-south"} component={FrankstonSouthPainters} />
      <Route path={"/painters-frankston-south"} component={FrankstonSouthPainters} />
      ...
      <Route path={"/painter-st-kilda"} component={StKildaPainters} />
      <Route path={"/painters-st-kilda"} component={StKildaPainters} />
      <Route path={"/painter-port-melbourne"} component={PortMelbournePainters} />
      <Route path={"/painters-port-melbourne"} component={PortMelbournePainters} />
      <Route path={"/painter-albert-park"} component={AlbertParkPainters} />
      <Route path={"/painters-albert-park"} component={AlbertParkPainters} />
      <Route path={"/painter-fitzroy"} component={FitzroyPainters} />
      <Route path={"/painters-fitzroy"} component={FitzroyPainters} />
      <Route path={"/painter-collingwood"} component={CollingwoodPainters} />
      <Route path={"/painter-clyde-north"} component={ClydeNorthPainters} />
      <Route path={"/painters-clyde-north"} component={ClydeNorthPainters} />
      <Route path={"/painters-collingwood"} component={CollingwoodPainters} />
      <Route path={"/painter-richmond"} component={RichmondPainters} />
      ...
      <Route path={"/painter-south-melbourne"} component={SouthMelbournePainters} />
      <Route path={"/painters-south-melbourne"} component={SouthMelbournePainters} />
      <Route path={"/painter-lyndhurst"} component={LyndhurstPainters} />
      <Route path={"/painters-lyndhurst"} component={LyndhurstPainters} />
      <Route path={"/painter-rowville"} component={RowvillePainters} />
      <Route path={"/painters-rowville"} component={RowvillePainters} />
      <Route path={"/painter-wantirna-south"} component={WantirnaSouthPainters} />
      <Route path={"/painters-wantirna-south"} component={WantirnaSouthPainters} />
      <Route path={"/painter-canterbury"} component={CanterburyPainters} />
      <Route path={"/painters-canterbury"} component={CanterburyPainters} />
      {/* Blog Pages */}
      ...
      <Route path={"/blog/how-to-choose-a-painter-melbourne"} component={ChoosingAPainterMelbourne} />
      <Route path={"/blog/how-to-paint-a-weatherboard-house-melbourne"} component={WeatherboardPaintingGuide} />
      {/* <generated-blog-routes> */}
      <Route path={"/blog/spray-vs-brush-painting-melbourne"} component={SprayVsBrushPaintingMelbourne} />
      ...
      <Route path={"/blog/what-to-paint-before-you-sell"} component={WhatToPaintBeforeYouSell} />
{/* </generated-blog-routes> */}
