        ...
        <div className="container max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-[#B3ACA1] mb-4">
              ...
              Here are the top interior colours we're painting across <Link href="/painter-brighton" className="text-[#C9A227] hover:underline">Brighton</Link>, 
              <Link href="/painter-toorak" className="text-[#C9A227] hover:underline"> Toorak</Link>, and 
              <Link href="/painter-malvern" className="text-[#C9A227] hover:underline"> Malvern</Link> homes this year:
            </p>
            ...
            <p className="text-[#B3ACA1] mb-4">
              ...
              Our <Link href="/services/interior-painting" className="text-[#C9A227] hover:underline">interior painting team</Link> recommends 
            ...
            <p className="text-[#B3ACA1] mb-4">
              ...
              <Link href="/painter-camberwell" className="text-[#C9A227] hover:underline"> Camberwell</Link> homes.
            </p>
            ...
            <p className="text-[#B3ACA1] mb-4">
              ...
              <Link href="/services/exterior-painting" className="text-[#C9A227] hover:underline"> exterior paint</Link> needs 
            ...
            <p className="text-[#B3ACA1] mb-4">
              ...
              popular in <Link href="/painter-toorak" className="text-[#C9A227] hover:underline">Toorak</Link> and 
              <Link href="/painter-brighton" className="text-[#C9A227] hover:underline"> Brighton</Link>.
            </p>
