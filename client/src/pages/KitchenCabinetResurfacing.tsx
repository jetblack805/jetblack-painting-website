...
export default function KitchenCabinetResurfacing() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      schema={serviceSchema({ serviceType: "Kitchen Cabinet Resurfacing", name: "Kitchen Cabinet Resurfacing Melbourne", description: "Professional kitchen cabinet resurfacing Melbourne. Premium 2-pack finishes, fraction of renovation cost, 5-star rated. Transform your kitchen. Free quotes - Call 0432 077 782.", canonical: "https://jetblackpainting.com/services/kitchen-cabinet-resurfacing/" })}
      />
      <Navbar />
        ...
        <div className="container max-w-4xl">
          ...
          >
            <div className="bg-[#F5F5F0] p-6 rounded-lg text-center">
              ...
              <h3 className="text-2xl font-bold text-[#0D0D0D] mb-2">30-50%</h3>
              <p className="text-gray-700">Less than full renovation</p>
            </div>
            <div className="bg-[#F5F5F0] p-6 rounded-lg text-center">
              <Zap className="w-12 h-12 text-[#00AACC] mx-auto mb-3" />
              <h3 className="text-2xl font-bold text-[#0D0D0D] mb-2">5-10</h3>
            ...
            <div className="bg-[#F5F5F0] p-6 rounded-lg text-center">
              ...
              <p className="text-gray-700">Kitchens transformed</p>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <h2 className="text-3xl font-bold text-[#0D0D0D] mb-6">Why Choose Our Kitchen Cabinet Resurfacing Service</h2>
          ...
          >
            <h2 className="text-3xl font-bold text-[#0D0D0D] mb-6">Kitchen Cabinet Resurfacing Service Areas</h2>
            <p className="text-gray-700 mb-4">We provide professional kitchen cabinet resurfacing services across all Melbourne suburbs including:</p>
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <h2 className="text-3xl font-bold text-[#0D0D0D] mb-6">Kitchen Cabinet Resurfacing FAQs</h2>
