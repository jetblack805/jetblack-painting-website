      ...
      <article className="pt-32 pb-16 bg-white">
        <div className="container max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-[#0D0D0D] mt-10 mb-4">Interior Painting Costs in Melbourne</h2>
              ...
              <table className="w-full border-collapse border border-gray-200 text-sm">
                <thead>
                  <tr className="bg-[#0D0D0D] text-white">
                    ...
                    <th className="border border-gray-300 p-3 text-left">Price Range (per m²)</th>
                    <th className="border border-gray-300 p-3 text-left">Typical Room Cost</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="bg-white">
                    <td className="border border-gray-200 p-3">Walls only (2 coats)</td>
                    <td className="border border-gray-200 p-3">$20 - $35</td>
                    <td className="border border-gray-200 p-3">$400 - $800</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="border border-gray-200 p-3">Walls + ceiling</td>
                    <td className="border border-gray-200 p-3">$25 - $45</td>
                    <td className="border border-gray-200 p-3">$600 - $1,200</td>
                  </tr>
                  <tr className="bg-white">
                    <td className="border border-gray-200 p-3">Full room (walls, ceiling, trim)</td>
                    <td className="border border-gray-200 p-3">$35 - $55</td>
                    <td className="border border-gray-200 p-3">$800 - $1,500</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="border border-gray-200 p-3">Whole house interior (3-bed)</td>
                    <td className="border border-gray-200 p-3">—</td>
                    <td className="border border-gray-200 p-3">$5,000 - $12,000</td>
                  </tr>
                  <tr className="bg-white">
                    <td className="border border-gray-200 p-3">Whole house interior (4-bed)</td>
                    <td className="border border-gray-200 p-3">—</td>
                    <td className="border border-gray-200 p-3">$8,000 - $18,000</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <p className="text-gray-700 mb-4">
              Our <Link href="/services/interior-painting" className="text-[#00AACC] hover:underline">interior painting services</Link> include 
              thorough preparation (filling holes, sanding, priming), premium Dulux or Taubmans paint, and a spotless cleanup.
            </p>

            <h2 className="text-2xl font-bold text-[#0D0D0D] mt-10 mb-4">Exterior Painting Costs in Melbourne</h2>
            
            <div className="overflow-x-auto mb-6">
              <table className="w-full border-collapse border border-gray-200 text-sm">
                <thead>
                  <tr className="bg-[#0D0D0D] text-white">
                    <th className="border border-gray-300 p-3 text-left">Home Size</th>
                ...
                <tbody>
                  <tr className="bg-white">
                    <td className="border border-gray-200 p-3">Small (single storey, &lt;150m²)</td>
                    <td className="border border-gray-200 p-3">$4,000 - $8,000</td>
                    <td className="border border-gray-200 p-3">Walls, fascia, gutters</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="border border-gray-200 p-3">Medium (double storey, 150-250m²)</td>
                    <td className="border border-gray-200 p-3">$8,000 - $15,000</td>
                    <td className="border border-gray-200 p-3">Walls, fascia, gutters, trim</td>
                  </tr>
                  <tr className="bg-white">
                    <td className="border border-gray-200 p-3">Large (250m²+)</td>
                    <td className="border border-gray-200 p-3">$15,000 - $30,000+</td>
                    <td className="border border-gray-200 p-3">Full exterior package</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <p className="text-gray-700 mb-4">
              Our <Link href="/services/exterior-painting" className="text-[#00AACC] hover:underline">exterior painting services</Link> use 
              weather-resistant coatings designed for Melbourne's harsh UV and variable climate. We also offer 
              <Link href="/services/roof-painting" className="text-[#00AACC] hover:underline"> roof painting</Link> from $3,500.
            </p>

            <h2 className="text-2xl font-bold text-[#0D0D0D] mt-10 mb-4">Factors That Affect Painting Costs</h2>
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-6">
              ...
              <li><strong>Location</strong> — Premium suburbs like <Link href="/painter-toorak" className="text-[#00AACC] hover:underline">Toorak</Link> and <Link href="/painter-brighton" className="text-[#00AACC] hover:underline">Brighton</Link> often have larger homes</li>
            </ul>

            <h2 className="text-2xl font-bold text-[#0D0D0D] mt-10 mb-4">How to Get an Accurate Quote</h2>
            ...
            <p className="text-gray-700 mb-6">
              With <strong>127+ five-star Google reviews</strong>, 13+ years of experience, and $20M public liability insurance, 
              Jetblack Painting is Melbourne's most trusted painting company. We service all suburbs including 
              <Link href="/painter-malvern" className="text-[#00AACC] hover:underline"> Malvern</Link>, 
              <Link href="/painter-camberwell" className="text-[#00AACC] hover:underline"> Camberwell</Link>, 
              <Link href="/painter-hawthorn" className="text-[#00AACC] hover:underline"> Hawthorn</Link>, and 
              <Link href="/keysborough-painters" className="text-[#00AACC] hover:underline"> Keysborough</Link>.
            </p>

            <div className="bg-[#F5F5F0] rounded-xl p-6 mt-8">
              <h3 className="text-xl font-bold text-[#0D0D0D] mb-3">Get Your Free Quote Today</h3>
              <p className="text-gray-700 mb-4">
