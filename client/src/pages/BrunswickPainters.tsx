...
export default function BrunswickPainters() {
  return (
    <SuburbPageTemplate
      suburb={suburb}
      title="Brunswick Painters | Heritage Homes | Jetblack Painting"
      description="Heritage and period home painters in Brunswick — 150 years of Melbourne building history. Victorian. Free quotes, 5-year guarantee. Call 0432 077 782."
