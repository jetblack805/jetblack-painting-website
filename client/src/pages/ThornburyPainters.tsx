...
export default function ThornburyPainters() {
  return (
    <SuburbPageTemplate
      suburb={suburb}
      title="Thornbury Painters | Heritage Homes | Jetblack Painting"
      description="Heritage and period home painters in Thornbury — Californian bungalows, Edwardian and Victorian homes. Free quotes, 5-year guarantee. Call 0432 077 782."
