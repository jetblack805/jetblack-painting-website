...
export default function ToorakPainters() {
  ...
  const faqs = [
    {
      question: "Do you offer free quotes in Toorak?",
      answer: "Yes — we provide free, no-obligation quotes for all painting projects in Toorak. Call 0432 077 782 or use our online form and we'll respond promptly."
    },
    {
      question: "What interior painting services do you offer in Toorak?",
    ...
    {
      question: "How do you protect Toorak homes from Melbourne's weather?",
    ...
    {
      question: "Are you experienced with grand Victorian and Edwardian mansions in Toorak?",
      answer: "Absolutely. We have extensive local experience painting grand Victorian and Edwardian mansions throughout Toorak and understand the specific surface requirements, colour palettes and heritage considerations of the area."
    },
    {
      question: "How long does an exterior repaint take in Toorak?",
      answer: "Most residential exterior repaints in Toorak take 2–4 days depending on the size and condition of the property. We'll give you a clear timeline in your free quote."
    }
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        ...
        style={{ backgroundImage: `url(/images/house-painting-toorak-melbourne.jpg)`, backgroundSize: "cover", backgroundPosition: "center" }}
      >
        ...
        <div className="container relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-3xl">
            ...
            <p className="text-lg text-gray-200 mb-8 max-w-2xl">
              Jetblack Painting delivers premium interior and exterior painting services across Toorak and greater Melbourne. Trusted by local homeowners for 13+ years.
            </p>
      ...
      <section className="py-20 bg-[#F5F5F0]">
        <div className="container max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Melbourne's climate is demanding — blazing summers, wet winters and everything in between. Jetblack Painting's exterior painting service in Toorak is built around weather protection first. We use industry-leading exterior coatings that resist UV fading, moisture penetration and surface cracking, keeping your home looking sharp for years. Our process starts with a thorough inspection of all exterior surfaces, followed by pressure washing, crack filling, sanding and priming before any topcoat is applied. From the rendered facades along Toorak Road to the weatherboard cottages near Toorak Village, we have the local knowledge and premium finishes to make your Toorak home stand out on the street.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Trusted by homeowners across the leafy streets of Toorak for premium results and reliable service.
            </p>
          </motion.div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: Star, title: "5-Star Rated", desc: "Consistently excellent Google reviews from Toorak homeowners." },
              { icon: MapPin, title: "Local Toorak Experience", desc: "We know the leafy streets of Toorak — the homes, the styles and the conditions." },
      ...
      <section className="py-20 bg-[#F5F5F0]">
        <div className="container max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
            <h2 className="text-3xl font-bold mb-5 text-[#0D0D0D]">Local Painting Projects in Toorak</h2>
            <p className="text-gray-600 text-lg leading-relaxed">
              Jetblack Painting has completed dozens of residential painting projects across the leafy streets of Toorak. From full interior and exterior repaints of grand Victorian and Edwardian mansions to pre-sale makeovers and investment property refreshes, our portfolio in Toorak speaks for itself. We take pride in understanding what makes each suburb unique — the architectural heritage, the street appeal expectations and the lifestyle of the people who live there. When you choose Jetblack Painting in Toorak, you're choosing a team that genuinely knows your neighbourhood and is committed to delivering results that exceed your expectations. Our work near Toorak Road and Toorak Village has earned us repeat clients and referrals throughout the area.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="container max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="mb-10">
            <h2 className="text-3xl font-bold text-[#0D0D0D]">FAQs — House Painters Toorak</h2>
          </motion.div>
      ...
      <section className="py-20 bg-[#00AACC] text-white">
        <div className="container text-center">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">Ready to Transform Your Toorak Home?</h2>
            <p className="text-lg mb-8 max-w-xl mx-auto opacity-90">Contact your local Toorak painters today for a free, no-obligation quote.</p>
