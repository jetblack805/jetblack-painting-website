...
Yes, and Highett has a lot of them. The suburb has taken on a great deal of medium-density housing, and the common property in those developments — entry lobbies, stairwells, balcony soffits, garage undercrofts, boundary and dividing fences — wears far faster than the inside of any single unit. We quote owners corporation work with the scope itemised line by line so a committee can actually read it, stage the work so residents keep access to entries and parking throughout, and carry $10 million public liability cover across the whole site.
