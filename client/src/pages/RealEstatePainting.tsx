      ...
      <section className="py-16">
        <div className="container max-w-4xl">
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <h2 className="text-3xl font-bold text-[#EDE6D8] mb-6">Why Agents and Vendors Choose Jetblack Painting</h2>
          ...
          >
            <h2 className="text-3xl font-bold text-[#EDE6D8] mb-6">Painting for Every Stage of a Property</h2>
            ...
            <div className="space-y-4 mb-6">
              <div>
                <h3 className="text-lg font-bold text-[#EDE6D8] mb-1">Pre-sale property painting</h3>
                <p className="text-[#B3ACA1]">Fast, broad-appeal repaints that lift presentation and photography before your sale campaign, timed around your styling and open-home dates.</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-[#EDE6D8] mb-1">Rental &amp; investment property painting</h3>
                <p className="text-[#B3ACA1]">Durable, washable finishes for landlords and property managers, with quick turnarounds scheduled around vacancy periods and tenancy changeovers.</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-[#EDE6D8] mb-1">Property styling &amp; agent coordination</h3>
                <p className="text-[#B3ACA1]">Neutral colour consultation and direct coordination with agents and stylists so the property presents at its best on listing day.</p>
              </div>
            </div>
            <div className="flex flex-wrap gap-3">
              <Link href="/services/interior-painting" className="bg-[#1A1713] px-4 py-2 rounded-lg border border-[#2A261F] text-[#EDE6D8] hover:border-[#D4AB3A] hover:text-[#D4AB3A] transition-all font-medium">Interior Painting</Link>
              <Link href="/services/exterior-painting" className="bg-[#1A1713] px-4 py-2 rounded-lg border border-[#2A261F] text-[#EDE6D8] hover:border-[#D4AB3A] hover:text-[#D4AB3A] transition-all font-medium">Exterior Painting</Link>
            </div>
          </motion.div>
          ...
          >
            <h2 className="text-3xl font-bold text-[#EDE6D8] mb-6">Real Estate Painting Service Areas</h2>
            <p className="text-[#B3ACA1] mb-4">We provide real estate painting for agents, vendors and investors across all Melbourne suburbs including:</p>
            <div className="flex flex-wrap gap-3">
              {suburbs.map((s) => (
                <Link
                  key={s.name}
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <h2 className="text-3xl font-bold text-[#EDE6D8] mb-6">Real Estate Painting FAQs</h2>
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/services/body-corporate-painting" className="text-[#C49826] hover:underline font-medium">Body Corporate Painting</Link>
