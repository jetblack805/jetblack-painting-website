      ...
      <article className="pt-32 pb-16 bg-[#131316]">
        <div className="container max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-[#EDEDEF] mt-10 mb-4">What is Kitchen Cabinet Resurfacing?</h2>
            ...
            <h2 className="text-2xl font-bold text-[#EDEDEF] mt-10 mb-4">Cost Comparison</h2>
            
            <div className="overflow-x-auto mb-6">
              <table className="w-full border-collapse border border-[#222227] text-sm">
                <thead>
                  <tr className="bg-[#0A0A0B] text-white">
                    <th className="border border-[#2A2A30] p-3 text-left">Option</th>
                    <th className="border border-[#2A2A30] p-3 text-left">Average Cost</th>
                    <th className="border border-[#2A2A30] p-3 text-left">Timeframe</th>
                    <th className="border border-[#2A2A30] p-3 text-left">Disruption</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="bg-[#131316]">
                    <td className="border border-[#222227] p-3 font-semibold">Cabinet Resurfacing</td>
                    <td className="border border-[#222227] p-3">$3,500 - $8,000</td>
                    <td className="border border-[#222227] p-3">3-5 days</td>
                    <td className="border border-[#222227] p-3">Minimal</td>
                  </tr>
            ...
            <h3 className="text-xl font-bold text-[#EDEDEF] mt-8 mb-3">Choose Resurfacing When:</h3>
            ...
            <h3 className="text-xl font-bold text-[#EDEDEF] mt-8 mb-3">Choose Replacement When:</h3>
            <ul className="list-disc pl-6 text-[#B4B4B8] space-y-2 mb-4">
            ...
            <h2 className="text-2xl font-bold text-[#EDEDEF] mt-10 mb-4">Our 2-Pack Cabinet Resurfacing Process</h2>
            
            <ol className="list-decimal pl-6 text-[#B4B4B8] space-y-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#EDEDEF] mt-10 mb-4">Popular Cabinet Colours in Melbourne</h2>
            
            <p className="text-[#B4B4B8] mb-4">
              The most requested cabinet colours across our projects in 
              <Link href="/painter-toorak" className="text-[#D0A050] hover:underline"> Toorak</Link>, 
              <Link href="/painter-brighton" className="text-[#D0A050] hover:underline"> Brighton</Link>, and 
              <Link href="/painter-malvern" className="text-[#D0A050] hover:underline"> Malvern</Link> are:
            </p>
