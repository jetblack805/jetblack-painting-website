...
export default function ExteriorPainting() {
  useEffect(() => {
    ...
    document.title = "Exterior House Painting Melbourne | Professional Painters | Jetblack Painting";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Expert exterior house painting in Melbourne. Professional weatherboard, render, and fascia painting. 13+ years experience, 5-star rated. Serving all Melbourne suburbs. Free quotes!"
      );
    }
    ...
    if (metaKeywords) {
      metaKeywords.setAttribute(
        "content",
        "exterior painting Melbourne, house painting Melbourne, weatherboard painting, render painting, fascia painting, professional painters, exterior painters"
      );
    }
    ...
    if (ogTitle) {
      ogTitle.setAttribute(
        "content",
        "Exterior House Painting Melbourne | Jetblack Painting"
      );
    }
    ...
    if (ogDescription) {
      ogDescription.setAttribute(
        "content",
        "Professional exterior painting services in Melbourne. Weatherboard, render, fascia & gutter painting. 5-star rated. Free quotes!"
      );
    }
    ...
    if (ogUrl) {
      ogUrl.setAttribute(
        "content",
        "https://jetblackpainting.manus.space/exterior-painting"
      );
    }
