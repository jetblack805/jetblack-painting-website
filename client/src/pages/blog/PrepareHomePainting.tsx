      ...
      <article className="pt-32 pb-16 bg-[#1A1713]">
        <div className="container max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-[#EDE6D8] mt-10 mb-4">Before the Painters Arrive</h2>
            ...
            <h3 className="text-xl font-bold text-[#EDE6D8] mt-8 mb-3">2. Identify Problem Areas</h3>
            <p className="text-[#B3ACA1] mb-4">
            ...
            <h2 className="text-2xl font-bold text-[#EDE6D8] mt-10 mb-4">What Professional Painters Handle</h2>
            ...
            <h2 className="text-2xl font-bold text-[#EDE6D8] mt-10 mb-4">Best Time to Paint in Melbourne</h2>
            ...
            <div className="bg-[#12100C] rounded-xl p-6 mt-8">
              <h3 className="text-xl font-bold text-[#EDE6D8] mb-3">Book Your Free Quote</h3>
              <p className="text-[#B3ACA1] mb-4">
