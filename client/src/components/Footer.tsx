...
const SERVICE_AREAS = [
  ...
  { name: "Hastings", href: "/painter-hastings/" },
  ...
  { name: "Lyndhurst", href: "/painter-lyndhurst/" },
  ...
  { name: "Rowville", href: "/painter-rowville/" },
  ...
  { name: "Wantirna South", href: "/painter-wantirna-south/" },
