        ...
        <div className="container max-w-4xl">
          ...
          <div className="bg-[#1a1a1a] rounded-2xl p-8 md:p-12 border border-gray-800 text-center mb-12">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-8 py-4 bg-[#00AACC] text-white font-bold text-lg rounded-lg hover:bg-[#0099bb] transition-colors"
            >
          ...
          <div className="bg-[#1a1a1a] rounded-2xl p-8 border border-gray-800 mb-12">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                <span className="flex-shrink-0 w-8 h-8 bg-[#00AACC] text-white rounded-full flex items-center justify-center font-bold">1</span>
                <div>
              ...
              <div className="flex items-start gap-4">
                <span className="flex-shrink-0 w-8 h-8 bg-[#00AACC] text-white rounded-full flex items-center justify-center font-bold">2</span>
                <div>
              ...
              <div className="flex items-start gap-4">
                <span className="flex-shrink-0 w-8 h-8 bg-[#00AACC] text-white rounded-full flex items-center justify-center font-bold">3</span>
                <div>
              ...
              <div className="flex items-start gap-4">
                <span className="flex-shrink-0 w-8 h-8 bg-[#00AACC] text-white rounded-full flex items-center justify-center font-bold">4</span>
                <div>
          ...
          <div className="bg-[#1a1a1a] rounded-2xl p-8 border border-gray-800 mb-12">
            ...
            <div className="flex items-center gap-2 bg-[#0D0D0D] rounded-lg p-3">
              ...
              <button
                onClick={handleCopy}
                className="flex items-center gap-1 px-4 py-2 bg-[#00AACC] text-white rounded-md hover:bg-[#0099bb] transition-colors text-sm font-medium"
              >
                {copied ? (
                  <>
