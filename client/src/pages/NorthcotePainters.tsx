...
export default function NorthcotePainters() {
  return (
    <SuburbPageTemplate
      suburb={suburb}
      title={`${suburb} Painters | Victorian, Edwardian & Bungalow Specialists | Jetblack Painting`}
      description={`Expert painters in ${suburb} — Victorian terraces, Edwardian homes, Californian bungalows and rental properties along High Street and St Georges Road. Free quotes, 5-year guarantee, $10M insurance.`}
