...
export default function RichmondPainters() {
  return (
    <SuburbPageTemplate
      ...
      description={`Expert painters in ${suburb} — Victorian terraces, Edwardian cottages, warehouses and rental properties along Church Street, Bridge Road and Swan Street. Free quotes, 5-year guarantee, $10M insurance.`}
