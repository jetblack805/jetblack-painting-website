      ...
      <article className="pt-32 pb-16 bg-[#1A1713]">
        <div className="container max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-[#EDE6D8] mt-10 mb-4">Interior Paint Colours Trending in Melbourne 2026</h2>
            ...
            <p className="text-[#B3ACA1] mb-4">
              ...
              Here are the top interior colours we're painting across <Link href="/painter-brighton" className="text-[#C49826] hover:underline">Brighton</Link>, 
              <Link href="/painter-toorak" className="text-[#C49826] hover:underline"> Toorak</Link>, and 
              <Link href="/painter-malvern" className="text-[#C49826] hover:underline"> Malvern</Link> homes this year:
            </p>

            <h3 className="text-xl font-bold text-[#EDE6D8] mt-8 mb-3">1. Warm Whites & Off-Whites</h3>
            <p className="text-[#B3ACA1] mb-4">
              ...
              Our <Link href="/services/interior-painting" className="text-[#C49826] hover:underline">interior painting team</Link> recommends 
              these for open-plan living areas where you want a bright, airy feel.
            </p>

            <h3 className="text-xl font-bold text-[#EDE6D8] mt-8 mb-3">2. Sage Green & Eucalyptus Tones</h3>
            <p className="text-[#B3ACA1] mb-4">
              ...
              <Link href="/painter-camberwell" className="text-[#C49826] hover:underline"> Camberwell</Link> homes.
            </p>

            <h3 className="text-xl font-bold text-[#EDE6D8] mt-8 mb-3">3. Deep Navy & Charcoal</h3>
            <p className="text-[#B3ACA1] mb-4">
            ...
            <h2 className="text-2xl font-bold text-[#EDE6D8] mt-10 mb-4">Exterior Paint Colours for Melbourne's Climate</h2>
            
            <p className="text-[#B3ACA1] mb-4">
              Melbourne's variable weather — from scorching summers to cold, wet winters — means your 
              <Link href="/services/exterior-painting" className="text-[#C49826] hover:underline"> exterior paint</Link> needs 
              to withstand UV exposure, moisture, and temperature fluctuations. Here's what's working in 2026:
            </p>

            <h3 className="text-xl font-bold text-[#EDE6D8] mt-8 mb-3">4. Warm Greys & Greige</h3>
            <p className="text-[#B3ACA1] mb-4">
            ...
            <h3 className="text-xl font-bold text-[#EDE6D8] mt-8 mb-3">5. Dark Exteriors with Light Trim</h3>
            <p className="text-[#B3ACA1] mb-4">
              ...
              popular in <Link href="/painter-toorak" className="text-[#C49826] hover:underline">Toorak</Link> and 
              <Link href="/painter-brighton" className="text-[#C49826] hover:underline"> Brighton</Link>.
            </p>

            <h2 className="text-2xl font-bold text-[#EDE6D8] mt-10 mb-4">Tips for Choosing the Right Colour</h2>
            ...
            <h2 className="text-2xl font-bold text-[#EDE6D8] mt-10 mb-4">Free Colour Consultation with Jetblack Painting</h2>
            ...
            <div className="bg-[#12100C] rounded-xl p-6 mt-8">
              <h3 className="text-xl font-bold text-[#EDE6D8] mb-3">Ready to Transform Your Home?</h3>
              <p className="text-[#B3ACA1] mb-4">
