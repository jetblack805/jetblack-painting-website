      ...
      <article className="pt-32 pb-16 bg-[#1A1713]">
        <div className="container max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-[#EDE6D8] mt-10 mb-4">What is Kitchen Cabinet Resurfacing?</h2>
            ...
            <h2 className="text-2xl font-bold text-[#EDE6D8] mt-10 mb-4">Cost Comparison</h2>
            
            <div className="overflow-x-auto mb-6">
              <table className="w-full border-collapse border border-[#2A261F] text-sm">
                <thead>
                  <tr className="bg-[#0D0D0D] text-white">
                    <th className="border border-[#332E26] p-3 text-left">Option</th>
                    <th className="border border-[#332E26] p-3 text-left">Average Cost</th>
                    <th className="border border-[#332E26] p-3 text-left">Timeframe</th>
                    <th className="border border-[#332E26] p-3 text-left">Disruption</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="bg-[#1A1713]">
                    <td className="border border-[#2A261F] p-3 font-semibold">Cabinet Resurfacing</td>
                    <td className="border border-[#2A261F] p-3">$3,500 - $8,000</td>
                    <td className="border border-[#2A261F] p-3">3-5 days</td>
                    <td className="border border-[#2A261F] p-3">Minimal</td>
                  </tr>
                  <tr className="bg-[#17140F]">
                    <td className="border border-[#2A261F] p-3 font-semibold">Full Kitchen Renovation</td>
                    <td className="border border-[#2A261F] p-3">$25,000 - $60,000+</td>
                    <td className="border border-[#2A261F] p-3">4-8 weeks</td>
                    <td className="border border-[#2A261F] p-3">Major</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <h2 className="text-2xl font-bold text-[#EDE6D8] mt-10 mb-4">When to Resurface vs Replace</h2>
            
            <h3 className="text-xl font-bold text-[#EDE6D8] mt-8 mb-3">Choose Resurfacing When:</h3>
            ...
            <h3 className="text-xl font-bold text-[#EDE6D8] mt-8 mb-3">Choose Replacement When:</h3>
            <ul className="list-disc pl-6 text-[#B3ACA1] space-y-2 mb-4">
            ...
            <h2 className="text-2xl font-bold text-[#EDE6D8] mt-10 mb-4">Our 2-Pack Cabinet Resurfacing Process</h2>
            
            <ol className="list-decimal pl-6 text-[#B3ACA1] space-y-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#EDE6D8] mt-10 mb-4">Popular Cabinet Colours in Melbourne</h2>
            
            <p className="text-[#B3ACA1] mb-4">
              The most requested cabinet colours across our projects in 
              <Link href="/painter-toorak" className="text-[#C9A227] hover:underline"> Toorak</Link>, 
              <Link href="/painter-brighton" className="text-[#C9A227] hover:underline"> Brighton</Link>, and 
              <Link href="/painter-malvern" className="text-[#C9A227] hover:underline"> Malvern</Link> are:
            </p>
            ...
            <div className="bg-[#12100C] rounded-xl p-6 mt-8">
              <h3 className="text-xl font-bold text-[#EDE6D8] mb-3">Transform Your Kitchen Today</h3>
              <p className="text-[#B3ACA1] mb-4">
