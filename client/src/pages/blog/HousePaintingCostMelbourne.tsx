      ...
      <article className="pt-32 pb-16 bg-[#131316]">
        <div className="container max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-[#EDEDEF] mt-10 mb-4">Exterior Painting Costs in Melbourne</h2>
            
            <div className="overflow-x-auto mb-6">
              <table className="w-full border-collapse border border-[#222227] text-sm">
                <thead>
                  <tr className="bg-[#0A0A0B] text-white">
                    <th className="border border-[#2A2A30] p-3 text-left">Home Size</th>
                    <th className="border border-[#2A2A30] p-3 text-left">Price Range</th>
                    <th className="border border-[#2A2A30] p-3 text-left">Includes</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="bg-[#131316]">
                    <td className="border border-[#222227] p-3">Small (single storey, &lt;150m²)</td>
                    <td className="border border-[#222227] p-3">$4,000 - $8,000</td>
                    <td className="border border-[#222227] p-3">Walls, fascia, gutters</td>
                  </tr>
                  <tr className="bg-[#101013]">
                    <td className="border border-[#222227] p-3">Medium (double storey, 150-250m²)</td>
                    <td className="border border-[#222227] p-3">$8,000 - $15,000</td>
                    <td className="border border-[#222227] p-3">Walls, fascia, gutters, trim</td>
                  </tr>
                  <tr className="bg-[#131316]">
                    <td className="border border-[#222227] p-3">Large (250m²+)</td>
                    <td className="border border-[#222227] p-3">$15,000 - $30,000+</td>
                    <td className="border border-[#222227] p-3">Full exterior package</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <h2 className="text-2xl font-bold text-[#EDEDEF] mt-10 mb-4">How to Get an Accurate Quote</h2>
            ...
            <p className="text-[#B4B4B8] mb-6">
              ...
              <Link href="/keysborough-painters" className="text-[#D0A050] hover:underline"> Keysborough</Link>.
            </p>
