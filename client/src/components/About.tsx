...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 lg:py-28 bg-[#060607]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -right-4 lg:-right-8 w-40 sm:w-52 overflow-hidden shadow-xl border-4 border-[#060607]">
                <img loading="lazy" decoding="async"
                  src={ABOUT_IMG}
          ...
          >
            ...
            <p className="text-[#EDEDEF]/60 font-light leading-[1.8] mb-8">
            ...
            {/* Signature */}
            <div className="mb-10">
              <div className="text-[#D0A050] text-4xl lux-signature">Jimmy</div>
              <div className="text-[9.5px] tracking-[0.3em] uppercase text-[#98989D] mt-1.5">Founder &amp; Director</div>
            </div>
...
function ValueCard({ value, delay }: { value: (typeof values)[number]; delay: number }) {
  ...
  return (
    ...
    >
      <div className="w-10 h-10 border border-[#D0A050]/35 flex items-center justify-center shrink-0">
        <value.icon className="w-4.5 h-4.5 text-[#D0A050]" strokeWidth={1.5} />
      </div>
      <div>
        <h3 className="text-[#EDEDEF] text-[11px] font-bold tracking-[0.12em] uppercase mb-1.5" style={{ fontFamily: "system-ui, sans-serif" }}>{value.title}</h3>
        <p className="text-[#EDEDEF]/50 text-xs font-light leading-relaxed">{value.description}</p>
      </div>
    </div>
  );
}
