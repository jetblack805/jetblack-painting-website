...
const services = [
  {
    ...
    description: "Transform your living spaces with flawless interior finishes. From walls and ceilings to trims and doors, we deliver a fresh, clean look throughout your home.",
    image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663339742950/KYFGAGWwrHFpqGZW.jpeg",
  },
  {
    icon: Paintbrush,
    title: "Exterior House Painting",
    description: "Boost your curb appeal with a professional exterior repaint. We handle weatherboards, render, fascias, gutters, and more — built to withstand Melbourne's weather.",
    image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663339742950/rEhHpLqiuktAVhOl.jpeg",
  },
  {
    icon: Building2,
    title: "Commercial Painting",
    description: "Keep your commercial spaces looking professional. We work with offices, retail shops, warehouses, and factories — minimising disruption to your business.",
    image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663339742950/mQxpXRxNSxlrzUtw.jpeg",
  },
  {
    icon: PaintBucket,
    title: "Pre-Sale Property Refresh",
    description: "Maximise your property's value before selling. A fresh coat of paint is one of the most cost-effective ways to increase buyer appeal and achieve a higher sale price.",
    image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663339742950/kBOMcHSWYZOFHhIp.jpeg",
  },
  {
    icon: Warehouse,
    title: "Rental Property Repaints",
    description: "We work with landlords, property managers, and real estate agencies to keep rental properties in top condition between tenancies. Fast turnaround guaranteed.",
  ...
  },
  {
    ...
    description: "Complete your property's transformation with roof restoration and fence painting. We handle preparation, priming, and finishing for a long-lasting result.",
